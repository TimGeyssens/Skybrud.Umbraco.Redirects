...
namespace Skybrud.Umbraco.Redirects.EventHandlers
{
    ...
    {
        private const string ContextKey1 = "Skybrud.Umbraco.Redirects.RedirectTrackingEventHandler.1";
        private const string ContextKey2 = "Skybrud.Umbraco.Redirects.RedirectTrackingEventHandler.2";
        private const string ContextKey3 = "Skybrud.Umbraco.Redirects.RedirectTrackingEventHandler.3";
...
;
        ...
        private static bool IsReplicaServer
        {
            get
            {
                ...
                var serverRole = registrar == null ? ServerRole.Unknown : registrar.GetCurrentServerRole(); 
